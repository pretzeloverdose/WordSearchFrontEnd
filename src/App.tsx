...
function App() {
  return (
    <div className="App">
      ...
      <div style={{width: 'fit-content', maxWidth: '100%', margin: '0 auto', textAlign: 'left', borderRadius: 5, boxSizing: 'border-box'}}>
      <pre className='psuedoCode' style={{ textAlign: 'left', margin: 0, fontFamily: 'monospace', lineHeight: 1.3, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
